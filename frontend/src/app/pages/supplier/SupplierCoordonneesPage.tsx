/** Coordonnées du fournisseur : consultation et modification de son propre profil (FRS-02). */
...
export function SupplierCoordonnees({ nav }: { nav: Nav }) {
  ...
  return (
    <ScreenShell nav={nav} title="Mes coordonnées" back="supplier-products">
      <FormCard title="Mes coordonnées" subtitle="Tenez à jour les informations de votre société. Votre e-mail de connexion et vos catégories sont gérés par l'équipe À la Source.">
        {loading ? (
          ...
          <form onSubmit={submit} className="space-y-4">
            ...
            <div className="flex items-center gap-3">
              <BtnNavy type="submit" className="flex-1 justify-center">
                <Check className="w-4 h-4" /> {sending ? "Enregistrement…" : "Enregistrer mes coordonnées"}
              </BtnNavy>
